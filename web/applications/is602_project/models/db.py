...
# In the web interface, which variable to plot
target_variable = ['AGE_ADJUSTED_CI_LOWER', 'AGE_ADJUSTED_CI_UPPER', 'AGE_ADJUSTED_RATE',  'CRUDE_CI_LOWER', 'CRUDE_CI_UPPER', 'CRUDE_RATE']
